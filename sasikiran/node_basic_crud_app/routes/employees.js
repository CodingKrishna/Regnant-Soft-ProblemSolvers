...
exports.list = function(req, res){
  ...
  req.getConnection(function(err,connection){
        ...
        var query = connection.query('SELECT * FROM employee',function(err,rows)
        {
            ...
            res.render('employees',{page_title:"EMPLOYEES LIST - UI",data:rows});
...
exports.add = function(req, res){
  res.render('add_employee',{page_title:"Adding EMPLOYEE in UI Team"});
};
...
exports.edit = function(req, res){
    ...
    req.getConnection(function(err,connection){
        ...
        var query = connection.query('SELECT * FROM employee WHERE id = ?',[id],function(err,rows)
        {
            ...
            res.render('edit_employee',{page_title:"Editing EMPLOYEE in UI Team",data:rows});
